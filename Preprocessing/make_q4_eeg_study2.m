...
new_folder = '\\\......\\Tong_computer\\Dissertation Study 2\\EEG data\\preprocessing2\\eeg_cleaned_q4';
...
for i = 1:length(files)
    ...
    ttl_file = fullfile(ttl_folder, strrep(files(i).name, '_processed.set', '_modified_events_q4.txt'));
    ...
    new_file_name = strcat(base_name, '_q4ttl'); % Append '_q1ttl'
